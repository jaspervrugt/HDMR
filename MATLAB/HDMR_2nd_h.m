function [y_res,y_ij,C2,T2,it] = HDMR_2nd_h(B1,y_res,R,n2,m1,m2,c2,lambda)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
%                                                                         %
...
%                                                                         %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Second order - individual estimation and backfitting (HDMR high)        %
%                                                                         %
%  SYNOPSIS                                                               %
%   [y_res,y_ij,C2,T2,it] = HDMR_2nd_h(B1,y_res,R,n2,m1,m2,c2,lambda)     %
%                                                                         %
...
for j = 1:n2
    ...
    for z = 1:m2
        B2 = B1(1:R,beta(z,1),c2(j,1)) .* B1(1:R,beta(z,2),c2(j,2));
    end
    B22 = B2'*B2;
    if det(B22) == 0
        % Ill-defined --> C2(:,k) = 0;
